package com.tcc.psiuser.utils;

public class BuildEmail {

    public static String buildEmail(String title, String name, String message, String link, String botton) {
