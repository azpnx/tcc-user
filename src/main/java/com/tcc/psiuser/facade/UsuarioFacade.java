...
public class UsuarioFacade {
    ...
    public void save(Usuario usuario){
        ...
        String link = MessageFormat.format("http://34.95.148.80:8125/api/usuarios/confirmar?token=" + token, ENDPOINT_EMAIL);
    ...
    public void resetPassword(String email){
        ...
        String link = MessageFormat.format("http://34.95.148.80:8125/api/usuarios/changePassword?token=" + token, ENDPOINT_EMAIL);
